...
Begin VB.Form FrmCheque 
   ...
   Begin VB.ListBox List1 
      Appearance      =   0  'Flat
      Height          =   810
      ItemData        =   "cheque.frx":0F9B
      Left            =   2760
      List            =   "cheque.frx":0FA5
      TabIndex        =   18
      Top             =   4560
      Visible         =   0   'False
      Width           =   1335
   ...
   Begin TrueOleDBGrid80.TDBGrid DBGTransacciones 
      ...
      Splits(0).Caption=   "Comprobante del Cheque"
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.ComboBox CmbMoneda 
         Height          =   315
         ItemData        =   "cheque.frx":22652B
         Left            =   5880
         List            =   "cheque.frx":226538
         TabIndex        =   3
         Top             =   720
         Width           =   1815
      End
                ...
                If Not FrmCheque.DtaTasas.Recordset.EOF Then
                 ...
                 Select Case FrmCheque.CmbMoneda.Text
                  Case "Córdobas"
                    ...
                    Me.ChkCheque.Caption = "Imprimir Cheque, Dolares"
...
Me.DBGTransacciones.Enabled = True
     ...
     FrmCheque.DBGTransacciones.Columns(0).Button = True
     FrmCheque.DBGTransacciones.Columns(5).Caption = "Cheq/Rec"
     FrmCheque.DBGTransacciones.Columns(6).Button = True
     FrmCheque.DBGTransacciones.Columns(6).Locked = True
     FrmCheque.DBGTransacciones.Columns(0).Width = 1500
     FrmCheque.DBGTransacciones.Columns(2).Width = 1000
     FrmCheque.DBGTransacciones.Columns(3).Caption = "Descripcion"
     FrmCheque.DBGTransacciones.Columns(4).Width = 1000
     FrmCheque.DBGTransacciones.Columns(4).Button = True
     FrmCheque.DBGTransacciones.Columns(5).Width = 1000
     FrmCheque.DBGTransacciones.Columns(6).Width = 800
     FrmCheque.DBGTransacciones.Columns(7).Width = 1200
     FrmCheque.DBGTransacciones.Columns(7).NumberFormat = "##,##0.000000"
     FrmCheque.DBGTransacciones.Columns(8).Width = 1200
     FrmCheque.DBGTransacciones.Columns(8).NumberFormat = "##,##0.00"
     FrmCheque.DBGTransacciones.Columns(9).Width = 1200
     FrmCheque.DBGTransacciones.Columns(9).NumberFormat = "##,##0.00"
     FrmCheque.DBGTransacciones.Columns(10).Visible = False
     FrmCheque.DBGTransacciones.Columns(11).Visible = False
     FrmCheque.DBGTransacciones.Columns(12).Visible = False
     FrmCheque.DBGTransacciones.Columns(13).Visible = False
     FrmCheque.DBGTransacciones.Columns(14).Visible = False
     FrmCheque.DBGTransacciones.Columns(15).Visible = False
'     FrmCheque.DBGTransacciones.Columns(16).Visible = False
'     FrmCheque.DBGTransacciones.Columns(17).Visible = False
'     FrmCheque.DBGTransacciones.Columns(18).Visible = False
'     FrmCheque.DBGTransacciones.Columns(19).Visible = False
'     FrmCheque.DBGTransacciones.Columns(20).Visible = False
'     FrmCheque.DBGTransacciones.Columns(21).Visible = False
'     FrmCheque.DBGTransacciones.Columns(22).Visible = False
 
      FrmCheque.DBGTransacciones.SetFocus
      FrmCheque.DBGTransacciones.PostMsg (5)
 ...
 End If
       ...
       If Not DtaConsulta.Recordset.EOF Then
        If Not Me.DBGTransacciones.Columns(3).Text = "" Then
          ...
          Me.DtaConsulta.Recordset("Fuente") = "CHEQUE"
          Me.DtaConsulta.Recordset.Update
        End If
       End If
...
'///////imprimo el reporte/////
    ...
    Me.DtaConsulta.RecordSource = "SELECT Transacciones.CodCuentas, Transacciones.NombreCuenta, Transacciones.VoucherNo, Transacciones.DescripcionMovimiento, Transacciones.FacturaNo, Transacciones.ChequeNo, Transacciones.Clave, Transacciones.TCambio, Transacciones.Debito, Transacciones.Credito, Transacciones.FechaTransaccion, Transacciones.NPeriodo, Transacciones.NTransaccion, Transacciones.Fuente, Transacciones.FechaTasas, Transacciones.NumeroMovimiento, Periodos.Periodo, Transacciones.Beneficiario , Transacciones.FechaVence FROM Periodos INNER JOIN  Transacciones ON Periodos.NPeriodo = Transacciones.NPeriodo WHERE (Transacciones.ChequeNo = '#######') AND (Transacciones.CodCuentas = '" & Me.DBCodigo.Text & "') AND (Transacciones.DescripcionMovimiento <> '**********CANCELADO*************') ORDER BY Transacciones.NTransaccion"
    Me.DtaConsulta.Refresh
    If Not Me.DtaConsulta.Recordset.EOF Then
     Me.DtaConsulta.Recordset.MoveLast
     If Me.DtaConsulta.Recordset.RecordCount = 1 Then
       FrmImprimeCheque.LblConsecutivo = Consecutivo
       FrmImprimeCheque.LblCuenta = Me.TxtNombreBanco
       FrmImprimeCheque.Show 1
     Else
       FrmListadoCheques.LblConsecutivo = Consecutivo
       FrmListadoCheques.Show 1
     End If
...
Select Case ColIndex
  ...
  If TipoCuenta = "Bancos" Then
   ...
   '/////////////////////////////////////////////////////////////////////////////////
         ...
         Me.DBGTransacciones.Columns(15).Text = FrmCheque.TxtNTransacciones.Text
...
Me.TxtFuente.Text = "CHEQUE"
Primero = True
Salir = True
'On Error GoTo TipoErrs
Dim SqlCheque As String
With Me.DtaContratista
   .RecordSource = "AdelantosJustifica"
...
If Not DBCodigo.Text = "" Then
  If TxtMonto.Text = "" Then
   Credito = 0
  ElseIf IsNumeric(Me.TxtMonto) Then
   Credito = Me.TxtMonto
  End If
...
'                TipoMoneda = DtaCuentas.Recordset("TipoMoneda")
      ...
      If Me.TxtMonto.Text = "" Then
         MontoCheque = 0
      ElseIf IsNumeric(Me.TxtMonto.Text) Then
           MontoCheque = Me.TxtMonto.Text
      End If
