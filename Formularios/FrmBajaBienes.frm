...
Begin VB.Form FrmBajaBienes 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   375
         Left            =   2760
         OleObjectBlob   =   "FrmBajaBienes.frx":058A
         TabIndex        =   18
         Top             =   240
         Width           =   2535
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel6 
         Height          =   255
         Left            =   120
         OleObjectBlob   =   "FrmBajaBienes.frx":0606
         TabIndex        =   27
         Top             =   240
         Width           =   1095
      End
   ...
   Begin VB.Frame Rechazo 
      ...
      Begin TrueOleDBGrid80.TDBGrid DataGrid7 
         Bindings        =   "FrmBajaBienes.frx":067E
         Height          =   2415
         Left            =   120
         TabIndex        =   23
         Top             =   240
   ...
   Begin MSDataListLib.DataCombo cmdgrupo2 
      Bindings        =   "FrmBajaBienes.frx":0697
      DataField       =   "Idreg"
      Height          =   360
      Left            =   1680
      TabIndex        =   4
   ...
   Begin MSDataListLib.DataCombo dtrespo 
      Bindings        =   "FrmBajaBienes.frx":06AA
      DataField       =   "IdReg"
      Height          =   360
      Left            =   240
      TabIndex        =   7
   ...
   Begin MSDataListLib.DataCombo dtrespo2 
      Bindings        =   "FrmBajaBienes.frx":06C1
      DataField       =   "IdReg"
      Height          =   360
      Left            =   4800
      TabIndex        =   8
   ...
   Begin MSDataListLib.DataCombo dtrespo3 
      Bindings        =   "FrmBajaBienes.frx":06D8
      DataField       =   "IdReg"
      Height          =   360
      Left            =   3000
      TabIndex        =   11
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
      Height          =   255
      Left            =   120
      OleObjectBlob   =   "FrmBajaBienes.frx":06EF
      TabIndex        =   19
      Top             =   840
      Width           =   1455
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
      Height          =   255
      Left            =   120
      OleObjectBlob   =   "FrmBajaBienes.frx":076F
      TabIndex        =   20
      Top             =   1200
      Width           =   1455
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
      Height          =   255
      Left            =   120
      OleObjectBlob   =   "FrmBajaBienes.frx":07EB
      TabIndex        =   21
      Top             =   1680
      Width           =   1455
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel5 
      Height          =   255
      Left            =   5400
      OleObjectBlob   =   "FrmBajaBienes.frx":0863
      TabIndex        =   22
      Top             =   840
      Width           =   855
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel7 
      Height          =   255
      Left            =   4200
      OleObjectBlob   =   "FrmBajaBienes.frx":08CB
      TabIndex        =   24
      Top             =   6240
      Width           =   975
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel8 
      Height          =   255
      Left            =   1320
      OleObjectBlob   =   "FrmBajaBienes.frx":093D
      TabIndex        =   25
      Top             =   5520
      Width           =   735
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel9 
      Height          =   255
      Left            =   6000
      OleObjectBlob   =   "FrmBajaBienes.frx":09AB
      TabIndex        =   26
      Top             =   5520
      Width           =   975
   End
...
Private Sub ActivosDisponiblesAlta(opcionFiltro As Integer)
    ...
    If opcionFiltro = 1 Then 'filtra todos los activos que aun no se le han dado de alta
        ...
        adoactivos.RecordSource = "select idreg as IdActivo, DescripcionAF as Descripcion, Serie as Marbete,fcompragen as Fecha_Adquisicion, Marca from dbo.CatalogoActivoFijo  WHERE (DatoAlta = 1)"
    End If
...
Set rsa = Nothing
SQL = "update CatalogoActivoFijo set DatoAlta=0,dadobaja=1, FechaBaja='" & Format(Now, "dd/MM/yyyy") & "'  where Idreg='" & Trim(idactivobaja) & "'"
rsa.Open SQL, Conexion, adOpenForwardOnly, adLockOptimistic
End Sub
