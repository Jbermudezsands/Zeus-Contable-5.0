VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ArepResultadoAcumulado 
   ...
   _ExtentX        =   26882
   _ExtentY        =   19368
   SectionData     =   "ArepResultadoAcumulado.dsx":0000
End
Attribute VB_Name = "ArepResultadoAcumulado"
...
Attribute VB_Exposed = False
    ...
    Dim TotalIngresosOperativos As Double
      Dim TotalCostoMercaderiaFinal  As Double
    Dim TotalIngresosOperativosFinal As Double
...
'    TotalCostoMercaderiaFinal = CDbl(Me.Field3.Text)
...
'    TotalIngresosOperativosFinal = CDbl(Me.Field3.Text)
''    Me.Field2.Text = CDbl(Me.Field6.Text)
'End If

'If UCase(Me.Field1.Text) Like UCase("*utilidad bruta*") Then
'    Me.Field5.Text = Format(TotalIngresosOperativos - TotalCostoMercaderia, "###,###,###,##0.#0")
'    Me.Field3.Text = Format(TotalIngresosOperativosFinal - TotalCostoMercaderiaFinal, "###,###,###,##0.#0")
'End If
