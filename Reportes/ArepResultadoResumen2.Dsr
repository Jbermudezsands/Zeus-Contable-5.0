VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} ArepResultadoResumen2 
   ...
   _ExtentX        =   33655
   _ExtentY        =   19368
   SectionData     =   "ArepResultadoResumen2.dsx":0000
End
Attribute VB_Name = "ArepResultadoResumen2"
...
'        Me.LblVentas.Caption = Format(Totalingresos, "##,##0.00")
        ...
        Totalingresos = TotalOtrosIngresos + Totalingresos - ResultadoPersonalizado
...
'        Me.LblVentas.Caption = Format(Totalingresos, "##,##0.00")
        ...
        Totalingresos = TotalOtrosIngresos + Totalingresos - ResultadoPersonalizadoPeriodo
        Me.LblTotalIngreso.Caption = Format(Totalingresos, "##,##0.00")
     End If
...
'        Me.LblOtrosIngresos.Caption = Format(TotalOtrosIngresos - TotalOtrosGastos, "##,##0.00")
        Me.LblOtrosGastos.Caption = Format(TotalOtrosGastos, "##,##0.00")
     Else
        TotalOtrosGastos = 0
        SaldosPersonalizados ("Otros Gastos")
...
'        Me.LblOtrosIngresos.Caption = Format(TotalOtrosIngresos - TotalOtrosGastos, "##,##0.00")
    ...
    Me.LblTotalGastoOperacion.Caption = Format(TotalGastoVentas + TotalGastosAdmon + TotalIngresosFinancieros + TotalOtrosGastos, "##,##0.00")
    ...
    End If
'    TotalUtilidadNeta = TotalUtilidadBruta - (TotalGastoVentas + TotalGastosAdmon + TotalIngresosFinancieros + TotalOtrosGastos) - TotalImpuestos
