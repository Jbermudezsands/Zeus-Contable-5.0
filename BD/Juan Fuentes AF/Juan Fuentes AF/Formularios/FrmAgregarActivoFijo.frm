...
Begin VB.Form FrmAgregarActivoFijo 
   ...
   Begin MSDataListLib.DataCombo vehi 
      Bindings        =   "FrmAgregarActivoFijo.frx":E94B
      DataField       =   "idvh"
      Height          =   360
      Left            =   1800
      TabIndex        =   11
   ...
   Begin MSDataListLib.DataCombo combustible 
      Bindings        =   "FrmAgregarActivoFijo.frx":E95D
      DataField       =   "idcombus"
      Height          =   360
      Left            =   1800
      TabIndex        =   15
   ...
   Begin MSDataListLib.DataCombo grupodc 
      Bindings        =   "FrmAgregarActivoFijo.frx":E973
      DataField       =   "IdSede"
      Height          =   360
      Left            =   1800
      TabIndex        =   18
   ...
   Begin MSDataListLib.DataCombo DataCombo3 
      Bindings        =   "FrmAgregarActivoFijo.frx":E988
   ...
   Begin VB.Label Label41 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   $"FrmAgregarActivoFijo.frx":E99E
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
...
Private Sub ccombus()
CargaADODC "CatCombus", combus, "", combustible.Name, "Trim", ConexionContable, Me, "order by idcombus"
End Sub
Private Sub cvh()
CargaADODC "CataVH", vh, "", vehi.Name, "Trim", ConexionContable, Me, "order by idvh"
End Sub
